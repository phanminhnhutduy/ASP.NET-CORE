...
namespace DoAnASP.Areas.User.Controllers
{
    ...
    public class TaiKhoansController : Controller
    {
        ...
        // GET: User/TaiKhoans/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: User/TaiKhoans/Create
